...
<p data-height="300" data-theme-id="9796" data-slug-hash="YPPmGL" data-default-tab="result" data-user="Sp00ky" data-pen-title="Sticky Notification Bar" className="codepen">See the Pen <a href="https://codepen.io/Sp00ky/pen/YPPmGL/">Sticky Notification Bar</a> by Andreas Eracleous (<a href="https://codepen.io/Sp00ky">@Sp00ky</a>) on <a href="https://codepen.io">CodePen</a>.</p>
<script async src="https://static.codepen.io/assets/embed/ei.js"></script>

<h2 className="mt-5">How Sticky Notification Bar works</h2>
...
<h3 className="mt-5">How to create CSS Click Events</h3>
...
<pre><code className="language-css">&lt;input type="checkbox"&gt;</code></pre>

In the style code:

<pre><code className="language-css">input [type=checkbox]:checked ~ #notification-bar  {
...
<h3 className="mt-5">Animation - CSS3 3D Transforms</h3>
...
<pre><code className="language-css">/* ANIMATION for go up */ 
...
<h3 className="mt-5">Source Code</h3>
