    ...
    */}
			...
			<div className="row">
				<div className="col-lg mt-5">
					...
					<p className="font-weight-light">
						...
						maintained by Andreas Eracleous. It’s developed with the latest
						front-end technology, built on GatsbyJS, mobile-first with
						Bootstrap, optimised for a fast page load, hosted on GitHub and
				...
				<div className="col-lg mt-5">
					...
					<a
						href="https://twitter.com/AndrewEracleous"
						target="_blank"
					...
					<div itemScope itemType="http://schema.org/Person" className="mt-4">
						...
						<a
							itemProp="email"
							href="mailto:andrew.eracleous@gmail.com"
							className="text-white"
						>
							andrew.eracleous@gmail.com
						</a>
					</div>
				</div>
			</div>
		...
		<div className="bg-opacity mt-5 py-3">
			<div className="container d-flex flex-wrap">
				<p className="m-0 my-auto small">
					© {new Date().getFullYear()},{' '}
					<Link to="/" className="text-decoration-none text-white">
						<span className="text-capitalize">{siteTitle}</span>
					</Link>{' '}
					All Rights Reserved.
				</p>
				<nav className="ml-auto">
					<ul className="nav small">
						<li className="nav-item">
							<Link
								to="/privacy-policy"
								className="nav-link nav-link-footer text-white"
							>
								Privacy Policy
							</Link>
						</li>
