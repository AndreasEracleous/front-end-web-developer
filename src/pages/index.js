...
import { faTwitter, faFacebook, faGithub, faLinkedin, faInstagram, faWordpress} from '@fortawesome/free-brands-svg-icons'
import {faDesktop, faRocket, faRss} from '@fortawesome/pro-light-svg-icons'
    ...
    <div className="hero-banner bg-primary">
      ...
      <div className="bg-opacity text-secondary mt-4 py-2">
        <div className="d-flex container">
          <p className="font-weight-light my-0">Top Rated Freelancer on <span className="text-success">UpWork</span></p>        </div>
      </div>
      </div>
...
<div className="col-md-3 col-lg mb-4">
  ...
  <a href="#" className="p-1 text-dark"><FontAwesomeIcon icon={faTwitter} size="lg" /></a>
  <a href="#" className="p-1 text-dark"><FontAwesomeIcon icon={faFacebook} size="lg" /></a>
  <a href="#" className="p-1 text-dark"><FontAwesomeIcon icon={faGithub} size="lg" /></a>
  <a href="#" className="p-1 text-dark"><FontAwesomeIcon icon={faLinkedin} size="lg" /></a>
  <a href="#" className="p-1 text-dark"><FontAwesomeIcon icon={faInstagram} size="lg" /></a>
</div>
...
<p>I am currently available on UpWork for front-end development jobs. I can help you with: <strong>website performance optimization</strong>, <strong>Wordpress installation</strong> and <strong>conversion design to Bootstrap</strong>, <strong>HTML, CSS, JS code</strong> in which adaptive and <strong>responsive templates</strong> for all devices by using the latest web technologies.</p>
  ...
  <article className="d-flex flex-column bg-white shadow-sm border p-4 h-100 text-primary">
  <header className="d-flex mb-3">  
    ...
    <a className="btn btn-primary mt-auto" href="hire-psd-to-bootstrap-html-developer">Click Here To Learn More</a>
  </article>
  </div>
<div className="col-md-6 col-lg mt-4">
<article className="d-flex flex-column bg-white shadow-sm border p-4 h-100 text-primary">
...
<a className="btn btn-primary mt-auto" href="faster-website-speed-load-time">Click Here To Learn More</a>
</article>
</div>
...
<a className="btn btn-primary mt-auto" href="setup-wordpress-hosting">Click Here To Learn More</a>
</article>
</div>      
  </div>
</section>
...
<a href="https://cryptocoininvest.com/" target="_blank" rel="noopener" className="btn btn-sm btn-outline-primary">Visit website</a>
</div>
</article>
...
<article className="row mt-5">
  ...
  <header>
    ...
    <a href="https://www.energi.world/" target="_blank" rel="noopener" className="btn btn-sm btn-outline-primary">Visit website</a>
    </div>
</article>
...
<article className="row mt-5">
  ...
  <p>Maida is a website for Pipe Relining business on Sydney.</p>
    ...
    <a href="https://www.maida.com.au/" target="_blank" rel="noopener" className="btn btn-sm btn-outline-primary">Visit website</a>
  </div>
...
<h3 className="h4 font-weight-normal text-uppercase mb-4">Why you might want to hire me</h3>
...
<a href="#" className="btn btn-outline-success px-4">Hire me</a>
</section>
...
<div className="row">
  ...
  <div className="col-lg form-group">
    ...
    <input type="email" className="form-control form-control-lg" id="inputEmail" aria-describedby="emailHelp" />
  </div>  
</div>  
