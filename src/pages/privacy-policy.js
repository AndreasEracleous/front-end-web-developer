...
<Layout>
    ...
    <div className="container py-5">
        <h2>andreaseracleous.com Privacy Policy</h2>
        ...
        <p>We will notify you via email
            ...
            <br/>
            <strong>•</strong> Within 7 business days</p>
        ...
        <p>If at any time you would like to unsubscribe from receiving future emails, you can email us at
            <strong>•</strong> Follow the instructions at the bottom of each email. and we will promptly remove you from <strong>ALL</strong> correspondence.</p>
        <strong>Contacting Us</strong>
        <p>If there are any questions regarding this privacy policy, you may contact us using the information below.</p>
        <p>andreaseracleous.com
            <br/> 10 Scopelou Ayios Athanasios
            <br/> Limassol, N/A 4105
            <br/> Cyprus
            <br/> contact@andreaseracleous.com
            <br/> Last Edited on 2017-02-04</p>
    </div>
</Layout>
)
