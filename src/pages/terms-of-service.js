...
<Layout>
    ...
    <div className="bg-primary py-3">
        ...
        <h1 className="font-weight-normal">Term Of Service</h1>
        </div>
    </div>       
    <div className="container py-5">
        <p>Last updated: February 04, 2017</p>
        <p>These Terms of Service ("Terms", "Terms of Service") govern your relationship with https://andreaseracleous.com/ website (the "Service") operated by Andreas Eracleous ("us", "we", or "our").</p>
        ...
        <p>The Service and its original content, features and functionality are and will remain the exclusive property of Andreas Eracleous and its licensors. The Service is protected by copyright, trademark, and other laws of both the Cyprus and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Andreas Eracleous.</p>
        <strong>Links To Other Web Sites</strong>
        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by Andreas Eracleous.</p>
        <p>Andreas Eracleous has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Andreas Eracleous shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
