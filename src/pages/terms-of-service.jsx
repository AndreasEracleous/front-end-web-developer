	...
	<>
		...
		<div className="container py-5">
			...
			<p>
				...
				relationship with https://andreaseracleous.com/ website (the "Service")
				operated by Andreas Eracleous ("us", "we", or "our").
			</p>
			<p>
			...
			<p>
				...
				will remain the exclusive property of Andreas Eracleous and its
				licensors. The Service is protected by copyright, trademark, and other
				laws of both the Cyprus and foreign countries. Our trademarks and trade
				dress may not be used in connection with any product or service without
				the prior written consent of Andreas Eracleous.
			</p>
			<strong>Links To Other Web Sites</strong>
			<p>
				Our Service may contain links to third-party web sites or services that
				are not owned or controlled by Andreas Eracleous.
			</p>
			<p>
				Andreas Eracleous has no control over, and assumes no responsibility
				for, the content, privacy policies, or practices of any third party web
				sites or services. You further acknowledge and agree that Andreas
				Eracleous shall not be responsible or liable, directly or indirectly,
			...
			<p>
				In no event shall Andreas Eracleous, nor its directors, employees,
			...
			<p>
				Andreas Eracleous its subsidiaries, affiliates, and its licensors do not
			...
			<p>
				...
				of Cyprus, without regard to its conflict of law provisions.
			</p>
			<p>
